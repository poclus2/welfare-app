  ...
  return (
    <div className="p-5 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#2A2424]/40 mt-0.5">Gestion de la base clients</p>
      </div>
      <div className="bg-white rounded-2xl border border-[#EDE0E0] p-12 flex flex-col items-center justify-center text-center shadow-sm">
        ...
        <p className="text-sm text-[#2A2424]/40 max-w-xs">La fiche client avec historique des commandes arrive bientôt.</p>
      </div>
    </div>
  );
}
