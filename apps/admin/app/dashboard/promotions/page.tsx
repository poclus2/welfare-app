export default function PromotionsPage() {
  return (
    <div className="p-5 lg:p-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[#2A2424]" style={{ letterSpacing: "-0.02em" }}>Promotions</h1>
        <p className="text-sm text-[#2A2424]/40 mt-0.5">Codes promo et réductions</p>
      </div>
      <div className="bg-white rounded-2xl border border-[#EDE0E0] p-12 flex flex-col items-center justify-center text-center shadow-sm">
        ...
        <p className="text-sm text-[#2A2424]/40 max-w-xs">La gestion des codes promo et promotions arrive bientôt.</p>
      </div>
    </div>
  );
}
